...
cp "$TEMPLATES_DIR/prompts/xo.md" ./prompts/xo.template.md
echo "  ✓ prompts/ (xo, analyst, critic, synthesizer, judge templates)"
...
echo "Next steps:"
echo ""
echo "  SESSION 1 — Planning (burn context, one time only):"
echo ""
echo "  1. Load your source material into context"
echo "     Read manuscripts, papers, codebases — whatever the mission requires."
echo "     This is the one session where large context is expected and fine."
echo ""
echo "  2. Generate MISSION_PLAN.md and prompts/"
echo "     Design your task graph. Use echelon: xo for phases with multiple"
echo "     parallel workers. Use direct dispatch for single high-stakes tasks."
echo "     Write prompts/[task_id].md for every task in the plan."
echo "     Schema reference: see MISSION_PLAN.md"
echo ""
echo "  3. Commit and clear"
echo "     git add -A && git commit -m 'Echelon: mission plan generated'"
echo "     /clear   <-- context nuclear option, guilt-free"
echo ""
echo "  SESSION 2 — Execution (tiny context, runs for hours):"
echo ""
echo "  4. Launch the loop"
echo "     /echelon-launch"
echo "     Fresh Opus loads ECHELON.md + MISSION_PLAN.md + ACTIVITY.md."
echo "     Dispatches all ready tasks in parallel. Runs until MISSION COMPLETE."
echo ""
